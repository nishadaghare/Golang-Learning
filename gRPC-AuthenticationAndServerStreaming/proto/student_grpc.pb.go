...
type StudentServiceClient interface {
	...
	ListStudents(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StudentResponse], error)
}
...
func (c *studentServiceClient) ListStudents(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StudentResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StudentService_ServiceDesc.Streams[0], StudentService_ListStudents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Empty, StudentResponse]{ClientStream: stream}
...
type StudentService_ListStudentsClient = grpc.ServerStreamingClient[StudentResponse]
...
type StudentServiceServer interface {
	...
	ListStudents(*Empty, grpc.ServerStreamingServer[StudentResponse]) error
...
func (UnimplementedStudentServiceServer) ListStudents(*Empty, grpc.ServerStreamingServer[StudentResponse]) error {
...
func _StudentService_ListStudents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StudentServiceServer).ListStudents(m, &grpc.GenericServerStream[Empty, StudentResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StudentService_ListStudentsServer = grpc.ServerStreamingServer[StudentResponse]
